    	...
    	<section class="sort_container">
    		...
    		<div class="sort_item" :class="{choose_type:sortBy == 'food'}" >
	    		...
	    		<transition name="showlist" v-show="category">
                 ...
                 <div v-if="index" :key="index" class="category_right_li" @click="getCategoryIds(item.id, item.name)" :class="{category_right_choosed: restaurant_category_ids == item.id || (!restaurant_category_ids)&&index == 0}"></div>>
