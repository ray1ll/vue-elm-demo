                                            ...
                                            <section class="menu_food_description">
                                                <h3 class="food_description_head">
                                                    ...
                                                    <ul v-if="foods.attributes.length" class="attributes_ul">
                                                        <li v-if="attribute" >
                                                          <div v-for="(attribute, foodindex) in foods.attributes" :key="foodindex" :style="{color: '#' + attribute.icon_color,borderColor:'#' + attribute.icon_color}" :class="{attribute_new: attribute.icon_name == '新'}">
    ...
    export default {
        ...
        methods: {
            ...
            afterEnter(el){
                ...
                this.showMoveDot = this.showMoveDot.map();
