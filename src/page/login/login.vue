        ...
        methods: {
            ...
            async mobileLogin(){
                if (this.loginWay) {
                    ...
                    //用户名登录
                    console.log('User info submitted:', this.userAccount);
                    console.log('User info submitted:', this.passWord);
                    console.log('User info submitted:', this.codeNumber);
                ...
                if (!this.userInfo.user_id) {
                    ...
                    console.log('Before RECORD_USERINFO:', this.userInfo);
                    const result = this.RECORD_USERINFO(this.userInfo);
                    console.log('After RECORD_USERINFO:', result);
                    console.log('User info submitted:', result);
                    this.$router.go(-1);
